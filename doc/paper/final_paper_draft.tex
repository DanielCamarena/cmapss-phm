...
\title{Predictive Maintenance for NASA C-MAPSS:\\
An End-to-End PHM System with Calibrated RUL Prediction,
Risk Logic, and Scenario Analysis}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{assets/project_research_roadmap.png}
  \caption{Graphical abstract of the end-to-end PHM system: from NASA C-MAPSS data ingestion, predictive modeling (RF, HGB, LSTM, GRU), champion selection, deterministic agent layer (risk, recommendations, scenarios), to the final interactive dashboard (summary, analysis, scenarios, technical audit). The roadmap outlines the sequential and modular research workflow implemented in this work.}
  \label{fig:roadmap}
\end{figure}
...
\bibliography{final_paper_draft_references}
