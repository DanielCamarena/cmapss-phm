...
\begin{table}[H]
\centering
\caption{CMAPSS subsets and problem structure (T1).}
...
\end{tikzpicture}
\caption{Conceptual C-MAPSS turbofan monitoring schematic (F1), adapted from the NASA C-MAPSS user-guide context.}
\label{fig:engine_schematic}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Selected vs removed low-variance features (T2).}
\label{tab:features}
...
\begin{table}[H]
\centering
\caption{Global model metrics (T4).}
...
\begin{table}[H]
\centering
\caption{Per-dataset RMSE by model (T5).}
...
\begin{table}[H]
\centering
\caption{Latency and engineering trade-offs (T6).}
\label{tab:latency}
\begin{tabular}{lrrr}
\toprule
...
\begin{table}[H]
\centering
\caption{Scenario comparison example (T7).}
...
\begin{table}[H]
\centering
\caption{Failure modes and handling (T8).}
...
\begin{table}[H]
\centering
\caption{Contract and trace field mapping (T9).}
\label{tab:contracts}
\begin{tabular}{lll}
\toprule
...
\begin{subfigure}[b]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{dashboard_v1_4.png}
  \caption{Summary tab (F3).}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{dashboard_v1_5.png}
  \caption{Analysis tab (F4).}
\end{subfigure}
...
\begin{subfigure}[b]{0.48\textwidth}
  ...
  \caption{Scenarios tab (F5).}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{dashboard_v1_8.png}
  \caption{Technical Audit tab (F6).}
\end{subfigure}
...
\end{axis}
\end{tikzpicture}
\caption{RUL interval illustration (F7) using calibrated confidence-band policy around a point prediction.}
